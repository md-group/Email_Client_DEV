...
import com.mdgroup.model.table.AbstractTableItem;
...
public class EmailMessageBean extends AbstractTableItem{
	...
	public String toString() {
		return "EmailMessageBean " + "sender=" + sender.get() + ", subject=" 
				+ subject.get() + ", size=" + size.get();
	}
	...
	public void addAttacment(MimeBodyPart mbp){
